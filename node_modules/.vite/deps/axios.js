...
var encodeText = isFetchSupported && (typeof TextEncoder !== "undefined" ? ((encoder) => (str) => encoder.encode(str))(new TextEncoder()) : async (str) => new Uint8Array(await new Response(str).arrayBuffer()));
