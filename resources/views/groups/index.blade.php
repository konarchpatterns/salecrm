<x-app-layout>
    ...
    <x-content-layout title='Groups' subtitle="Manage your group here."  secondaryButton="Add New Group" link="roles.create">
                    ...
                    @foreach ($groups as $key => $group)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 text-right">
                                <button id="dropdownMenuIconButton" data-dropdown-toggle="{{ $group->id }}"
                                ...
                                <div id="{{ $group->id }}"
                                    ...
                                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownMenuIconButton">
                                        <li>
                                            <a href="{{ route('groups.show', $group->id) }}" class="block px-4 py-2 hover:bg-gray-100">View</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('groups.edit', $group->id) }}" class="block px-4 py-2 hover:bg-gray-100">Edit</a>
                                        </li>
                                        <li>
