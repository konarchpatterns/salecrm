...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        ...
        {{-- <div class=" overflow-hidden  w-full">
            <header class="absolute inset-x-0 top-0 z-50 bg-gray-100 w-full" >
        ...
        <div class = "flex justify-center items-center h-screen bg-[#f6f7fc]">
              <div class="ml-6 w-1/2 ">
                ...
                @auth
                <div class="mt-10 w-full flex items-center  gap-x-4">
                  <a href="{{ route('dashboard') }}" class="px-5 rounded-md bg-blue-800  py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#071a9a]"> Dashboard </a>
                </div>
                  @else
                <div class="mt-10 w-full flex items-center  gap-x-4">
                  <a href="{{ route('login') }}" class="px-5 rounded-md bg-blue-800 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#071a9a]"> Log-in </a>
                </div>
                @endif
              </div>
         <div class="my-auto hidden md:block h-full" >
          <img src= "{{asset('images/22.gif')}}" class="z-10 object-fit h-full"></img>
         </div>
