...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class=" overflow-hidden">
     ...
     <div class="w-2/4">
      <div class="relative isolate px-6 pt-2 lg:px-8 z-50">
        ...
        <div class="mx-10 max-w-2xl py-32 sm:py-40 lg:py-40">
          ...
          <div class="text-left">
            ...
            <div class="mt-10    flex items-center  gap-x-4">
              <a href="{{ route('dashboard') }}" class="rounded-md bg-blue-800 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#071a9a]"> Dashboard </a>
     ...
     <div class="my-auto " >
      <img src= "{{asset('22.gif')}}" class="z-10  h-[400px] "></img>
