    ...
    <body>
        ...
        <!-- Modal -->
        <div class="modal fade " id="bookingModal" tabindex="-1" aria-labelledby="exampleModalLabel" style="margin-top: 50px;"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Booking title</h5>
                        <button type="button" class="btn-close" id="cancelBtn1" data-bs-dismiss="modal"
                    ...
                    <div class="modal-body ">
                        ...
                        <div class=" d-flex ">
                            <label class="w-50 space-r-2">Created by:
                                <input type="text" disabled class="form-control" id="created_by"
                                    value="{{ Auth::user()->name }}">
                                <span id="creatError" class="text-danger"></span>
                            </label>
                            <label class="w-50 space-l-2">Updated by:
                                <input type="text" disabled class="form-control" id="updated_by"
                                    value="{{ Auth::user()->name }}">
        ...
        <div class="modal fade " id="viewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-top: 50px">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                                ...
                                error: function(error) {
                                    if (error.responseJSON.errors) {
                                        $('#titleError').html(error.responseJSON.errors
                                            .title);
                                        $('#startTimeError').html(error.responseJSON
                                            .errors.start_time);
                                        $('#endTimeError').html(error.responseJSON
                                            .errors.end_time);
                                        $('#discriptionError').html(error.responseJSON
                                            .errors.discription);
                                        $('#priorityError').html(error.responseJSON
                                            .errors.priority);
                                    }
                                },
                            });
