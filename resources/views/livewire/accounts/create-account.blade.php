                ...
                <div class="col-span-6 sm:col-span-3 ">
                    <h2 class="mb-4 text-xl py-4 font-bold text-gray-900 dark:text-white">Contacts</h2>
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                @if($key > 0)    
                                <button wire:click="removeInput({{$key}})" type="button" class="text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-full text-sm p-2 text-center inline-flex items-center me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                            ...
                            <div class="flex justify-center" >
                              <button type="button" wire:click="addInput" class=" flex items-center justify-center text-blue-600 text-sm py-4 cursor-pointer">
                            ...
                            <div class="col-span-6 sm:col-span-3 ">
                                <h2 class="mb-4 text-xl py-4 font-bold text-gray-900 dark:text-white">Emails</h2>
                                        ...
                                        <div class="flex gap-2 items-center">
                                            ...
                                            @if($key > 0)
                                            <button wire:click="removeInputEmail({{$key}})" type="button" class="text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-full text-sm p-2 text-center inline-flex items-center me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                                              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                                              <span class="sr-only">remove</span>
                                              </button>
                                            @endif
                                        ...
                                        @endforeach
                                        <div class="flex justify-center" >
                                        <button type="button" wire:click="addInputEmail" class="flex items-center justify-center text-blue-600 text-sm py-4  cursor-pointer">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd"></path></svg>
                                            <p class="ml-2">Add New Email</p>
                                        </button>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3 ">
                                            <h2 class="mb-4 text-xl py-4 font-bold text-gray-900 dark:text-white">Address</h2>
                                          </div>
                                          <div class="grid grid-cols-3  gap-2">
                                            <div class="w-full">
                                         ...
                                         <div class="w-full">
                                              ...
                                              <select class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" wire:model="country_id" wire:change="getCountryStates">
                                        ...
                                        <div class="grid grid-cols-3 py-3 gap-2">
                                            <div class="w-full">
                                                <label for="vendor_type" class="block text-sm font-medium text-gray-700">Vendor type</label>
                                                <select class="mt-1 block w-full py-2 px-3 border border-gray-300
                                                 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500
                                                  focus:border-indigo-500 sm:text-sm" wire:model="vendor_type">
                                            ...
                                            <div class="w-full">
                                              <label for="description" class="block text-sm font-medium text-gray-700">Business type</label>
                                              <input wire:model="business_type" type="text" class="mt-1 focus:ring-blue-500 focus:border-indigo-500
                                              block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"/>
                                            </div>
                                            <div class="w-full">
