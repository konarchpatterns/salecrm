                  ...
                  <div class="grid grid-cols-2  gap-2 pt-5">
                    ...
                    <div class="w-full">
                      ...
                      <div class="w-full relative">
                        ...
                        {{-- <button wire:click="onSelect({{$company->id}})" type="button" wire:click="onClick">{{$company->name}}</button> --}}
                        <input wire:model="cnames" class="mt-1 focus:ring-blue-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" type="text" value="{{ $cnames }}" disabled>
                        <input wire:model="cid" value="{{ $cid }}"   type="hidden">
                        ...
                        {{-- <div class="{{$open ? '' : 'hidden'}} w-full absolute  h-48 py-2 overflow-y-auto text-gray-700 dark:text-gray-200 space-y-2"> --}}
                          {{-- @foreach ($companies as $company)
                            <div class="hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                <button wire:click="onSelect({{$company->id}})" type="button" wire:click="onClick">{{$company->name}}</button></div>
                            @endforeach --}}
                        {{-- </div> --}}
