        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            <div class="w-full md:w-1/2">
                <form class="flex items-center">
                    ...
                    <svg class="h-10 mr-10" wire:click="export" id="Capa_1" style="enable-background:new 0 0 128 128; margin-right: 40px" version="1.1" viewBox="0 0 128 128" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">
                        .st0{fill:#21A365;}
                        .st1{fill:#107C41;}
                        .st2{fill:#185B37;}
                        .st3{fill:#33C481;}
                ...
                <tbody>
                    ...
                    @foreach ($users as $user)
                        <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full" src="https://avatar.iran.liara.run/public/boy?username={{ $user->EmployeeName }}" alt="">
                                        </div>
                                        <div class="ml-4">
                            ...
                            {{-- <td class="px-4 py-3"> {{ $user->AssignedBy }}</td> --}}
