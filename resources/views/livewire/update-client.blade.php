                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        shadow-sm focus:outline-none focus:ring-indigo-500
                         ...
                         @endforeach
                                ...
                                <div class="w-full">
                                    <label for="linkdinurl"
                                        class="block text-sm font-medium text-gray-700">Linkdinurl</label>
                                    <input type="text" wire:model="linkdinurl" autocomplete="linkdinurl"
                                        class="mt-1 focus:ring-blue-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                            </div>
                            ...
                            @foreach ($inputs as $key => $input)
                                <div>
                                    <input type="hidden" id="input_{{ $key }}_phoneId"
                                        wire:model.defer="inputs.{{ $key }}.phoneId"
                                        class=" mt-1 focus:ring-blue-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                ...
                                <div class="grid grid-cols-3  gap-2 items-center">
                                    ...
                                    @if ($key > 0)
                                        <div wire:click="removeInput({{ $key }},{{ $id }})"
                            ...
                            @foreach ($emailinputs as $key => $input)
                                <input type="hidden" id="emailinputs_{{ $key }}_emailId"
                                    wire:model.defer="emailinputs.{{ $key }}.emailId"
                                    class=" mt-1 focus:ring-blue-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    placeholder="id" autocomplete="off">
                                ...
                                <div class="grid grid-cols-3  gap-2 items-center">
                                    ...
                                    @if ($key > 0)
                                        <div wire:click="removeInputEmail({{ $key }},{{ $mailId }})"
                                            class="flex  text-red-600 text-sm w-full cursor-pointer ">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
